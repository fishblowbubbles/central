        ...
        content: [
          {
            ...
            images: [],
            text:
              "The school (NTHU) organised a short trip for us to Kaohsiung and Kenting, unfortunately the aftermath of the the typhoon, which included intermittent rain over 3 days and the closure of many attractions, meant that we had to skip many of our intended visits, thus the lack of pretty pictures to share. Didn't see to many disappointed faces in our crowd, as we enjoyed what we did manage to do. You can look up the scenic places on Google, their pictures are often, if not always, better than the ones I take anyway."
          },
          {
            heading: "Summer Breezes Can Get Really Strong",
            images: [],
            text:
              "During my last weekend in Taiwan, the year's first typhoon hit the island. The warnings came early, but the locals didn't seem to fazed by the news - businesses were open until the last minute. Nevertheless, as I discovered when I stepped outside to buy dinner just as the winds on the outer fringes of the storm arrived - a category 1 (weakest) typhoon is still a natural disaster, and you really don't want to be outdoors."
          },
          {
        ...
        content: [
          {
            ...
            images: [],
            text:
              "Meet Dave, my roommate, a sweet young Korean man who studies at the prestigious Seoul National University. Here are some examples of typical conversations we have during the day. Morning: 'Get up.' 'I don’t wanna get up.' Afternoon: 'What do you wanna eat?' 'I wanna eat something good.' 'Who doesn’t want to eat something good?' Evening: 'You wanna eat something good?' 'Of course I wanna eat something good.' 'Where do you wanna go?' Night: 'I’m hungry, can I have some biscuits?' Popular items include beef noodles, dumplings and fried chicken/pork steaks, but Japanese and Italian foods are very common, making up maybe half of the food stalls in the school canteens."
          },
          {
          ...
          },
          {
            ...
            images: [],
            text:
              "Mixed rice from the cafeteria is both tasty and cheap - but instead of a fork and a regular tablespoon, you'll have to use chopsticks and a duck spoon, and to make things more tricky, it's still served on a plate. Also, it is self-service, so you don't have to worry about having to look pretty (or handsome?) for the stall uncle, or any kind of bias in order to be given a generous portion - simply take as much veggies as you want, and pick the largest piece of meat!"
          }
        ]
      },
      {
        ...
        content: [
          {
            ...
            images: [],
            text:
              "All the buildings are standing like statues - they don't turn their heads as they see me walk by. All the sounds of the earth are like music; the breeze is so busy it don't miss a tree. Not the most attractive of tourist destinations, nonetheless worth a day's walkabout in the city centre. There are many free (but tiny) museums in the area - good places to take shelter from the heat, if nothing else."
          },
          {
            heading: "You Can Sleep Tight At Night",
            images: [],
            text:
              "If safety is your concern, you'll have little to worry about. Cockroaches patrol the corridors of the dormitory frequently, the kitten-sized rats secure the outside perimeter and blood-sucking drones occasionally check in on us while we're asleep (this feels like an invasion of privacy). Intruders will think twice before attempting to enter. Capturing the rats on camera has been difficult - I've spotted them lepaking in the pantry (their pantry, not ours, i.e. the trashcan - thank goodness!) a couple of times, but they scurry off quickly when they hear me approaching. I'm assuming it's because they're afraid that I'll complain to their supervisors."
          },
          {
            heading: "The Simple Things Are Easy To Forget",
            images: [],
            text:
              "In an icebreaker game, I had to pick for myself an English name. I chose 'Mark', and no one could remember it (an advantage for me, in this context). What I want to say is, if you are not already doing so, kindly provide a formula booklet during the examinations (Term 2 Physics, that's you), no matter how simple the equations may seem - not forgetting a few among such a great multitude of numbers and symbols is too difficult. What I'm really trying to say is, although there may not be much to see, it's the little unnoticed things that make living in Hsinchu a very pleasant experience, and I'm liking the place and people more with each passing day."
          }
        ]
      },
      {
        title: "First Impressions",
        thumbnail: "/assets/hongkong.jpg",
        date: "17 July 2017",
        description:
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, et. Eligendi quia optio cupiditate fugiat qui nesciunt, velit dolores deleniti.",
        content: [
          {
            ...
            images: [{ src: "/assets/hongkong.jpg", caption: "Caption!" }, { src: "/assets/highwest.jpg", caption: "Caption!" }],
            text:
          ...
          },
          {
            ...
            images: [{ src: "/assets/flats.jpg", caption: "A very very very very very very very very very very very very very long caption!" }],
            text:
